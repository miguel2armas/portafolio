...
import imgPhp from "../../../assets/img/logo/php.png"
import imgDart from "../../../assets/img/logo/dart.png"
import imgKotlin from "../../../assets/img/logo/kotlin.png"
import imgJava from "../../../assets/img/logo/java.png"
import imgReact from "../../../assets/img/logo/react.png"
import imgTs from "../../../assets/img/logo/ts.png"
...
import imgFlutter from "../../../assets/img/logo/flutter.png"
import imgPrestashop from "../../../assets/img/logo/prestashop.png"
import imgAndroid from "../../../assets/img/logo/android.png"

export const ContentSkills = () => {
  return (
    <div>
      <h2 className="ContentSkills__h2">Lenguajes que uso</h2>
      <div className="ContentSkills">
        <div className="Item">
          <div className="Item__contentHtml"/>
          <img className="Item__img" src={imgHtml} alt="html" />
          <div className="Item__text">Html (100%)</div>
          <div className="Item__textYear">4 años</div>
        </div>
        ...
        <div className="Item">
          ...
          <div className="Item__textYear">2 años</div>
        </div>
        ...
        <div className="Item">
          ...
          <div className="Item__textYear">3 años</div>
        </div>
        ...
        <div className="Item">
          ...
          <div className="Item__textYear">1 año</div>
        </div>
        ...
        <div className="Item">
          ...
          <div className="Item__textYear">6 meses</div>
        </div>
      ...
      <div className="ContentSkills">
        ...
        <div className="Item">
          ...
          <div className="Item__textYear">2 año</div>
        </div>
        <div className="Item">
