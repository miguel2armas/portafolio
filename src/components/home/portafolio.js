    ...
    render() {
        return (
            <div>
                ...
                <Carousel className={this.props.checkedTheme?('bg-dark'):('bg-light')} >
                            ...
                            <Row>
                                ...
                                <Col xs={12} sm={6}>
                                    <div className="text-start">
                                        <h3 className={this.props.checkedTheme?('text-white'):('text-dark')}><span className="fs-1 fs-sm-2">E-tournament</span></h3>
                    ...
                    <Carousel.Item interval={4500}>
                        ...
                        <Carousel.Caption>
                            <Row>
                                ...
                                <Col xs={12} sm={6}>
                                    <div className="text-start">
                                        <h3 className={this.props.checkedTheme?('text-white'):('text-dark')}><span className="fs-1 fs-sm-2">Tallmobile</span></h3>
                                        <h4 className={this.props.checkedTheme?('text-white'):('text-dark')}>
                    ...
                    <Carousel.Item interval={4500}>
                        ...
                        <Carousel.Caption>
                            <Row>
                                ...
                                <Col xs={12} sm={6}>
                                    <div className="text-start">
                                        <h3 className={this.props.checkedTheme?('text-white'):('text-dark')}><span className="fs-1 fs-sm-2">Tallmobile Apk</span></h3>
                                        <h4 className={this.props.checkedTheme?('text-white'):('text-dark')}>
                    ...
                    <Carousel.Item interval={4500}>
                        ...
                        <Carousel.Caption>
                            <Row>
                                ...
                                <Col xs={12} sm={6}>
                                    <div className="text-start">
                                        <h3 className={this.props.checkedTheme?('text-white'):('text-dark')}><span className="fs-1 fs-sm-2">AllCodeReader Apk</span></h3>
                                        <h4 className={this.props.checkedTheme?('text-white'):('text-dark')}>
                    ...
                    <Carousel.Item interval={4500}>
                        ...
                        <Carousel.Caption>
                            <Row>
                                ...
                                <Col xs={12} sm={6}>
                                    <div className="text-start">
                                        <h3 className={this.props.checkedTheme?('text-white'):('text-dark')}><span className="fs-1 fs-sm-2">VerificarPEP Apk</span></h3>
                                        <h4 className={this.props.checkedTheme?('text-white'):('text-dark')}>
                                            <span className="fs-0 fs-sm-1">Simple aplicacion creada en android nativo
